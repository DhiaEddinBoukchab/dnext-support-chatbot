...
Now provide the best possible answer:"""
    ...
    async def _run_contextual_stage(
        self,
        extracted_info: str,
        user_prompt: str,
        context: str = "",
    ...
    async def analyze_image(
        ...
        try:
            ...
            extraction = await self._run_extraction_stage(
            ...
            contextual = await self._run_contextual_stage(
                extracted_info=extracted_info,
                user_prompt=prompt,
                context=context,
            )
    ...
    # =========================
    async def extract_text(self, image_path: Optional[str] = None,
                     image_bytes: Optional[bytes] = None,
                     context: str = "") -> str:
    ...
    async def analyze_document(self, image_path: Optional[str] = None,
                        image_bytes: Optional[bytes] = None,
